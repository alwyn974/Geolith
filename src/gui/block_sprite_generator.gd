...
const _materials = [
	preload("res://src/blocks/terrain_material.tres"),
	preload("res://src/blocks/terrain_material_transparent.tres"),
	preload("res://src/blocks/terrain_material_foliage.tres")
]
