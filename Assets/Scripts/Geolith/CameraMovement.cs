...
namespace Geolith
{
    public class CameraMovement : MonoBehaviour
    {
        ...
        private bool _rightMouseBtnPress;
        private bool _leftMouseBtnPress;
        ...
        private void MouseAiming()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                _leftMouseBtnPress = true; // User is wanting to pan round 
            }
            else if (Input.GetMouseButtonUp(0))
            {
                Debug.Log("Mouse button up");
                _leftMouseBtnPress = false;
            }
